...
class Messages:
    ...
    eng_choose_cluster_fv = "Please choose the cluster you want to get vacancies for."
    ua_choose_cluster_fv = "Будь ласка оберіть кластер, для якого ви хотіли б отримати вакансії."
    ...
    eng_choose_option_add = lambda term_name="10 days", cluster_name="every", msg=eng_choose_option: f"{msg} Statistics will be shown for {cluster_name} cluster and {term_name} period of time."
    ua_choose_option_add = lambda term_name="10 днів", cluster_name="кожного", msg=ua_choose_option: f"{msg} Статистика буде показана для {cluster_name} кластера за період у {term_name}."
    ...
    eng_choose_terms_fv = "Choose period of time for which vacancies will be searched."
    ua_choose_terms_fv = "Оберіть період, за який підібрати вакансії."
    ...
    eng_choose_location_fv = "Choose location for which you want to get vacancies."
    ua_choose_location_fv = "Оберіть регіон, для якого ви хочете отримати вакансії."
    ...
    eng_result_fv = "A set of vacancies recieved by your request: "
    ua_result_fv = "Підбірка з вакансій, отриманих за вашим запитом: "
    eng_choose_level_fv = "Choose level: "
    ua_choose_level_fv = "Оберіть рівень: "
